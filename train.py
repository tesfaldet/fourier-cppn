...
parser.add_argument('-log_dir', '--log_dir', default=".logs", type=int)
parser.add_argument('-snap_dir', '--snapshot_dir', default=".snapshots", type=int)
...
my_config['snap_dir'] = args.snap_dir
